...
const ChatMainSidebar = ({isSidebarOpen , setIsSidebarOpen}) => {
  return (
    <div className={`absolute sm:relative sm:block sm:w-1/4 h-screen  overflow-hidden border-r border-gray-300 font-montserrat-regular z-50 ${isSidebarOpen ? "block w-2/3" : "hidden"}`} >
